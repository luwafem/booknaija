...
food: []
  ...
  // Added by onboarding 2026-04-27T15:41:42.450Z
  'shina': {
    name: 'shina',
    slug: 'shina',
    logo: 'https://res.cloudinary.com/deexaiik4/image/upload/v1777304249/xe475iwq6twpmtpingrd.jpg',
    ...
    accent: '#ec8272',
    avatar: '',
    hero: 'https://picsum.photos/seed/shina/800/600',
    gallery: [
      { group: 'my work', images: ['https://res.cloudinary.com/deexaiik4/image/upload/v1777304329/e5ermozeahy8q9ky9vdb.jpg', 'https://res.cloudinary.com/deexaiik4/image/upload/v1777304329/vcb8ur2kupzu8qqcwzdv.jpg', 'https://res.cloudinary.com/deexaiik4/image/upload/v1777304329/mphhkofxu5h4s0dsa5jz.jpg'] },
    ],
    socials: { instagram: 'wrurw', tiktok: 'wedub' },
    paystackPublicKey: PLATFORM_PAYSTACK_KEY,
    subaccountCode: 'ACCT_hi2wzh86d4dhbk3',
    calendarId: 'oghenevokemi@gmail.com',
    active: true,
    adsEnabled: true,
    carsEnabled: false,
    ...
    services: [
      {
        id: 'shina-1', name: 'nail install', duration: '1 hour', price: 1500, image: 'https://res.cloudinary.com/deexaiik4/image/upload/v1777304446/yxgnfwy7iljtisdrdfvt.jpg',
        images: ['https://res.cloudinary.com/deexaiik4/image/upload/v1777304446/yxgnfwy7iljtisdrdfvt.jpg', 'https://res.cloudinary.com/deexaiik4/image/upload/v1777304462/zz8malpaeilzrwk5h3t3.jpg', 'https://res.cloudinary.com/deexaiik4/image/upload/v1777304490/urkdxuxcmvi9xcviwgwv.jpg'],
        showDetails: true,
        description: 'steleto nail install'
      }
    ],
    products: [],
    cars: [],
  ...
  // Added by onboarding 2026-04-27T16:24:12.108Z
  'shoe-lash': {
    name: 'shoe lash',
    slug: 'shoe-lash',
