...
export default function PropertyCard({ property, accent, isDark, onSelect, whatsappBase }) {
  ...
  const handleCtaClick = (e) => {
    ...
    const fullUrl = `${baseUrl}${separator}text=${message}`;
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        {property.images && property.images.length > 0 ? (
          ...
          <div className="w-full h-full flex items-center justify-center" style={{ backgroundColor: accent + '08' }}>
            <svg className="w-12 h-12 opacity-15" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div className="flex items-center gap-2 text-xs mb-auto">
          {property.bedrooms !== undefined && property.bedrooms !== '' && (
            ...
            >
              <svg className="w-3.5 h-3.5 opacity-60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                <path d="M3 7v11M21 7v11M3 11h18M5 11V9a2 2 0 012-2h10a2 2 0 012 2v2M7 13h4m2 0h4" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
          ...
          {property.bathrooms !== undefined && property.bathrooms !== '' && (
            ...
            >
              <svg className="w-3.5 h-3.5 opacity-60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                <path d="M4 12h16a1 1 0 011 1v1a4 4 0 01-4 4H7a4 4 0 01-4-4v-1a1 1 0 011-1zm2-2V6m0 0a2 2 0 012-2m-2 2a2 2 0 012-2m0 0h0m8 4V6m0 0a2 2 0 00-2-2m2 2a2 2 0 00-2-2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
