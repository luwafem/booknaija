...
export default function PropertyHeader({ biz, accent, isDark }) {
  ...
  const ctaStyle = "inline-flex items-center gap-2.5 px-6 py-2.5 text-[11px] font-bold tracking-[0.15em] uppercase text-white rounded-full transition-all duration-300 hover:brightness-110 hover:shadow-sm";
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className={"hidden sm:inline-flex " + ctaStyle}
        ...
        >
          ...
          >
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className={"flex items-center justify-center gap-3 w-full " + ctaStyle}
              style={{ backgroundColor: accent }}
            >
