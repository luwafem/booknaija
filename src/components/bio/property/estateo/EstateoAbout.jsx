...
export default function EstateoAbout({ biz, accent }) {
  // Use biz.stats if available, else fallback
  ...
  const img2 = (biz.gallery && biz.gallery[1] && biz.gallery[1].images?.[0]) ||
    'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800';

  const waLink = buildWhatsAppLink(biz.whatsapp, `Hi ${biz.name}, I'd like to learn more.`);
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-base text-gray-600 leading-relaxed mb-8">
              {biz.bio ||
                `With years of experience in the Nigerian real estate market, ${biz.name} is committed to helping you find the property that fits your lifestyle and budget.`}
            </p>
