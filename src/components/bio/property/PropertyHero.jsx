...
export default function PropertyHero({ biz, accent, isDark }) {
  ...
  const ctaStyle = "group inline-flex items-center gap-3 px-8 py-4 text-white text-[11px] font-bold tracking-[0.2em] uppercase transition-all duration-300 hover:brightness-110 rounded-full shadow-sm";
