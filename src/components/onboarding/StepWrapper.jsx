// src/components/onboarding/StepWrapper.jsx
export default function StepWrapper({ children, title, description, step, totalSteps, onPrev, onNext, onFinish, loading, error }) {
  return (
    <div>
      <div className="mb-4">
